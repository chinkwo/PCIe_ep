...
HD_PWD='F:/FPGA_VIVADO/PCIe_ep/PCIE_EP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AC701_Gen1x4If64.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AC701_Gen1x4If64.tcl -notrace
