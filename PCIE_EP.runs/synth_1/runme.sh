...
HD_PWD='F:/FPGA_VIVADO/PCIe_ep/PCIE_EP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AC701_Gen1x4If64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AC701_Gen1x4If64.tcl
